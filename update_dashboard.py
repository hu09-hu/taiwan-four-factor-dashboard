...
const layout=(title,y='')=>({{title:{{text:title,x:0}},paper_bgcolor:'rgba(0,0,0,0)',plot_bgcolor:'rgba(0,0,0,0)',font:{{color:'#dbe7f5'}},margin:{{l:52,r:18,t:65,b:48}},hovermode:'x unified',xaxis:{{gridcolor:'#20314a'}},yaxis:{{title:y,gridcolor:'#20314a',zerolinecolor:'#64748b'}},legend:{{orientation:'h',y:1.14}}}});
const plot=(id,traces,title,y)=>Plotly.newPlot(id,traces,layout(title,y),{{responsive:true,displaylogo:false}});
